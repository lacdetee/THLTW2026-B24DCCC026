  ...
  return (
    <div style={{ padding: '24px', minHeight: '100vh', backgroundColor: '#f0f2f5' }}>
      <div style={{ marginBottom: 20, textAlign: 'center' }}>
        <Title level={3} style={{ color: '#d9363e', margin: 0 }}>HỆ THỐNG QUẢN LÝ ĐẶT LỊCH SALON</Title>
        <span style={{ fontSize: '16px', fontWeight: 'bold', color: '#555' }}>Sinh viên: Trần Nam Khánh | B24DCCC164</span>
      </div>

      <Card bordered={false} bodyStyle={{ padding: '20px' }} style={{ borderRadius: '8px', boxShadow: '0 2px 8px rgba(0,0,0,0.05)' }}>
        <Tabs defaultActiveKey="1" type="card" size="large">
          <TabPane tab={<span style={{ fontWeight: 'bold' }}>💇‍♂️ 1. Nhân Viên & Dịch Vụ</span>} key="1">
            <TabNhanVienDichVu />
          </TabPane>
